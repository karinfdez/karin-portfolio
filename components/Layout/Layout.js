...
export default function Layout({verticalTitle='', children }) {
  return (
    <div className='flex w-full xl:pt-8 xl:pb-[112px] lg:min-w-[380px] justify-center px-0 lg:px-6'>
        <div className='flex flex-col lg:px-4 3xl:px-8 w-full h-full xl:max-w-[1800px] 3xl:max-w-[2600px] items-center relative pt-4 md:pt-0'>
            ...
            <div className="flex w-full h-full items-center">
                <div className="flex flex-wrap-reverse w-full lg:grid lg:grid-cols-[10%_80%_10%] xl:grid-cols-[4%_92%_4%] items-center xl:py-[60px] 3xl:pt-[50px] md:max-h-100% my-auto">
